...
import { InfertilityFormValues } from '@/zod/infertility';
import {
  Activity,
  Baby,
  Briefcase,
...
import InfertilityEditMultiStepForm from './InfertilityEditMultiStepForm';
...
const InfertilityPatientDetailsClient = ({ patient, slug }: Props) => {
  const router = useRouter();
  const [isEditing, setIsEditing] = useState(false);

  const defaultValues = useMemo<InfertilityFormValues>(
    () => ({
    ...
    return (
      <div className="container mx-auto space-y-4 px-2">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-semibold">Edit Infertility Patient</h1>
...
export default InfertilityPatientDetailsClient;
