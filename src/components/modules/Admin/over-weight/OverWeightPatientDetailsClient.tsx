...
import { OverWeightFormValues } from '@/zod/over-weight';
import {
  Activity,
  Baby,
  Briefcase,
...
import OverWeightEditMultiStepForm from './OverWeightEditMultiStepForm';
...
const OverWeightPatientDetailsClient = ({ patient, slug }: Props) => {
  const router = useRouter();
  const [isEditing, setIsEditing] = useState(false);

  const defaultValues = useMemo<OverWeightFormValues>(
    () => ({
    ...
    return (
      <div className="container mx-auto space-y-4 px-2">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-semibold">Edit Overweight Patient</h1>
...
export default OverWeightPatientDetailsClient;
